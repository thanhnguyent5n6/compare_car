<div class="col-lg-9">
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="card card-car">
				<?php $second_car = session()->get('second_car'); ?>
				...
				<div class="compare-car card-header">
					...
					@foreach($style as $c)
						...
						@endif
					@endforeach
					<h4>Giá niêm yết: <span>{{ number_format($second_car->cars_price) }}đ</span></h4>
					<h4 class="marginbot50">Giá đàm phán: <span>{{ number_format($second_car->cars_promotion_price) }}đ</span></h4>
				</div>
				<div class="compare-car card-body">
					<div class="solidline"></div>
					<h2 class="text-title">Kích thước</h2>
